...
public class ColladaSource {
    ...
    public Vector3f getVec3(Integer index, String param1, String param2,
                            String param3) {
        if (getStride() == 3)
            return new Vector3f(getDouble(param1, index),
                    getDouble(param2, index), getDouble(param3, index));
        else
            return null;
    }

    public Vector3f getVec2(Integer index, String param1, String param2) {
        return new Vector3f(getDouble(param1, index),
