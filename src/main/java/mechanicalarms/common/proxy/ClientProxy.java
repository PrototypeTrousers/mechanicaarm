...
public class ClientProxy extends CommonProxy {
    ...
    public static void registerModels(ModelRegistryEvent event) {
        ...
        ModelLoader.setCustomModelResourceLocation(Items.ARM_BASE, 2, new ModelResourceLocation(new ResourceLocation(MechanicalArms.MODID, "models/block/arm_arm1.obj"), "arm_part=2"));
        ModelLoader.setCustomModelResourceLocation(Items.ARM_BASE, 3, new ModelResourceLocation(new ResourceLocation(MechanicalArms.MODID, "models/block/arm_arm2.obj"), "arm_part=3"));
